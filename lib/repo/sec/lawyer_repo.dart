...
class LawyersRepository {
  ...
  Future<InfoProfileModel> editProfile(EditEducationRQM rqm) async {
    try {
  ...
  Future<InfoProfileModel> editAddress(EditAddressRQM rqm)async {
    try{
  ...
  Future<InfoProfileModel> editSocial(EditSocialRQM rqm)async {
    try{
